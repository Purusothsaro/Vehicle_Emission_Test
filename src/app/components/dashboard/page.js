...
const dashboard = () => {
  ...
  useEffect(() => {
    ...
    setVehicleDetails({
      vehicleId: "37hg#$54gbh&^34@#45",
      vehicleName: "Yamaha",
      ownerName: "Purusothman",
      makeAndModel: "Yamaha FZs",
      yearOfMfd: "2018",
      licencePlateNo: "TN96B8765",
      engineNo: "tgh3847!#483iuhb3",
      vehicleType: "Gear",
            ...
            <div className="p-3">
              <div className="row g-2">
                <div className="col-md-6">
                  ...
                  <div className="fw-bold h6">{vehicleDetails.vehicleId}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Vehicle Number:</label>
                  <div className="fw-bold h6">{vehicleDetails.vehicleName}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Owner (User ID):</label>
                  <div className="fw-bold h6">{vehicleDetails.ownerName}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Make and Model:</label>
                  <div className="fw-bold h6">
                    {vehicleDetails.makeAndModel}
                  </div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Year of Manufacture:</label>
                  <div className="fw-bold h6">{vehicleDetails.yearOfMfd}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">License Plate Number:</label>
                  <div className="fw-bold h6">
                    {vehicleDetails.licencePlateNo}
                  </div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Engine number etc:</label>
                  <div className="fw-bold h6">{vehicleDetails.engineNo}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">Vehicle Type:</label>
                  <div className="fw-bold h6">{vehicleDetails.vehicleType}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">City of Registration:</label>
                  <div className="fw-bold h6">
                    {vehicleDetails.cityOfRegistration}
                  </div>
                </div>
                <div className="col-md-6">
                  <label className="form-label">
